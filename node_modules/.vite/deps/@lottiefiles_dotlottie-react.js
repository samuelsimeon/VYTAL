...
var e0 = Object.defineProperties;
var i0 = Object.getOwnPropertyDescriptors;
var N1 = Object.getOwnPropertySymbols;
var e3 = Object.prototype.hasOwnProperty;
var i3 = Object.prototype.propertyIsEnumerable;
var L2 = (d, i, n) => i in d ? t0(d, i, { enumerable: true, configurable: true, writable: true, value: n }) : d[i] = n;
var O = (d, i) => {
  for (var n in i || (i = {})) e3.call(i, n) && L2(d, n, i[n]);
  if (N1) for (var n of N1(i)) i3.call(i, n) && L2(d, n, i[n]);
  return d;
};
var N = (d, i) => e0(d, i0(i));
var n3 = (d, i) => {
  var n = {};
  for (var h in d) e3.call(d, h) && i.indexOf(h) < 0 && (n[h] = d[h]);
  if (d != null && N1) for (var h of N1(d)) i.indexOf(h) < 0 && i3.call(d, h) && (n[h] = d[h]);
  return n;
};
var p = (d, i, n) => L2(d, typeof i != "symbol" ? i + "" : i, n);
var y = (d, i, n) => new Promise((h, s) => {
  var m = (I) => {
    try {
      C(n.next(I));
    } catch (P) {
  ...
  }, C = (I) => I.done ? h(I.value) : Promise.resolve(I.value).then(m, M);
  C((n = n.apply(d, i)).next());
});
var n0 = class {
...
var a0 = class {
  constructor() {
    p(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new n0() : new r0();
  }
  requestAnimationFrame(d) {
...
var m2 = new Uint8Array([80, 75, 3, 4]);
var o0 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var r3 = "0.42.0";
var a3 = "@lottiefiles/dotlottie-web";
var s0 = 0.75;
var h0 = (() => {
  var d, i = typeof document < "u" ? (d = document.currentScript) == null ? void 0 : d.src : void 0;
  return function(n = {}) {
    var h, s = n, m, M, C = new Promise((t, e) => {
      m = t, M = e;
    }), I = Object.assign({}, s), P = "./this.program", A = "", n1;
    typeof document < "u" && document.currentScript && (A = document.currentScript.src), i && (A = i), A.startsWith("blob:") ? A = "" : A = A.substr(0, A.replace(/[?#].*/, "").lastIndexOf("/") + 1), n1 = (t) => fetch(t, { credentials: "same-origin" }).then((e) => e.ok ? e.arrayBuffer() : Promise.reject(Error(e.status + " : " + e.url)));
    var q = s.print || console.log.bind(console), J = s.printErr || console.error.bind(console);
    Object.assign(s, I), I = null, s.thisProgram && (P = s.thisProgram);
    var r1 = s.wasmBinary, _1, l1 = false, s1, Z, S, t1, z, K, w, k, m1;
    function L1() {
      var t = _1.buffer;
      s.HEAP8 = Z = new Int8Array(t), s.HEAP16 = t1 = new Int16Array(t), s.HEAPU8 = S = new Uint8Array(t), s.HEAPU16 = z = new Uint16Array(t), s.HEAP32 = K = new Int32Array(t), s.HEAPU32 = w = new Uint32Array(t), s.HEAPF32 = k = new Float32Array(t), s.HEAPF64 = m1 = new Float64Array(t);
    }
    var d1 = [], A1 = [], X = [];
    function p1() {
    ...
    function R1(t) {
      var e;
      throw (e = s.onAbort) == null || e.call(s, t), t = "Aborted(" + t + ")", J(t), l1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), M(t), t;
    }
    var C2 = (t) => t.startsWith("data:application/octet-stream;base64,"), O1;
    function M2(t) {
      if (t == O1 && r1) return new Uint8Array(r1);
      throw "both async and sync fetching of the wasm failed";
    }
    function d3(t) {
      return r1 ? Promise.resolve().then(() => M2(t)) : n1(t).then((e) => new Uint8Array(e), () => M2(t));
    }
    function b2(t, e, r) {
      return d3(t).then((a) => WebAssembly.instantiate(a, e)).then(r, (a) => {
        J(`failed to asynchronously prepare wasm: ${a}`), R1(a);
      });
    }
    function u3(t, e) {
      var r = O1;
      return r1 || typeof WebAssembly.instantiateStreaming != "function" || C2(r) || typeof fetch != "function" ? b2(r, t, e) : fetch(r, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, t).then(e, function(o) {
        return J(`wasm streaming compile failed: ${o}`), J("falling back to ArrayBuffer instantiation"), b2(r, t, e);
      }));
    }
    class I2 {
      constructor(e) {
        p(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${e})`, this.status = e;
      }
    }
    var X1 = (t) => {
      for (; 0 < t.length; ) t.shift()(s);
    }, Q1 = s.noExitRuntime || true, E2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, C1 = (t, e = 0, r = NaN) => {
      var a = e + r;
      for (r = e; t[r] && !(r >= a); ) ++r;
      if (16 < r - e && t.buffer && E2) return E2.decode(t.subarray(e, r));
      for (a = ""; e < r; ) {
        var o = t[e++];
        if (o & 128) {
          var l = t[e++] & 63;
          if ((o & 224) == 192) a += String.fromCharCode((o & 31) << 6 | l);
          else {
            var c = t[e++] & 63;
            o = (o & 240) == 224 ? (o & 15) << 12 | l << 6 | c : (o & 7) << 18 | l << 12 | c << 6 | t[e++] & 63, 65536 > o ? a += String.fromCharCode(o) : (o -= 65536, a += String.fromCharCode(55296 | o >> 10, 56320 | o & 1023));
          }
    ...
    var c3 = () => {
      ...
      for (var o of t) {
        if (o === 0 || o === a) break;
        if (V2(o, a, r.Ea + 16)) return F1(o), e;
      }
      return F1(a), e;
    }, M1 = (t, e, r) => {
      var a = S;
    ...
    var y1 = {}, c1 = {}, W1 = {}, I1, h1 = (t, e, r) => {
      function a(u) {
        if (u = r(u), u.length !== t.length) throw new I1("Mismatched type converter count");
        for (var f = 0; f < t.length; ++f) Q(t[f], u[f]);
      }
      t.forEach((u) => W1[u] = e);
      var o = Array(e.length), l = [], c = 0;
      e.forEach((u, f) => {
        c1.hasOwnProperty(u) ? o[f] = c1[u] : (l.push(u), y1.hasOwnProperty(u) || (y1[u] = []), y1[u].push(() => {
          o[f] = c1[u], ++c, c === l.length && a(o);
        }));
      }), l.length === 0 && a(o);
    }, P2, R = (t) => {
      for (var e = ""; S[t]; ) e += P2[S[t++]];
      return e;
    }, L;
    function f3(t, e, r = {}) {
      var a = e.name;
      if (!t) throw new L(`type "${a}" must have a positive integer typeid pointer`);
      if (c1.hasOwnProperty(t)) {
        if (r.kb) return;
        throw new L(`Cannot register type '${a}' twice`);
      }
      c1[t] = e, delete W1[t], y1.hasOwnProperty(t) && (e = y1[t], delete y1[t], e.forEach((o) => o()));
    }
    function Q(t, e, r = {}) {
      return f3(t, e, r);
    }
    var Z1 = (t) => {
      throw new L(t.Da.Ga.Fa.name + " instance already deleted");
    }, t2 = false, S2 = () => {
    }, F2 = (t, e, r) => e === r ? t : r.Ja === void 0 ? null : (t = F2(t, e, r.Ja), t === null ? null : r.cb(t)), k2 = {}, v3 = {}, _3 = (t, e) => {
      if (e === void 0) throw new L("ptr should not be undefined");
      for (; t.Ja; ) e = t.Ta(e), t = t.Ja;
      return v3[e];
    }, $1 = (t, e) => {
      if (!e.Ga || !e.Ea) throw new I1("makeClassHandle requires ptr and ptrType");
      if (!!e.Ka != !!e.Ia) throw new I1("Both smartPtrType and smartPtr must be specified");
      return e.count = { value: 1 }, E1(Object.create(t, { Da: { value: e, writable: true } }));
    }, E1 = (t) => typeof FinalizationRegistry > "u" ? (E1 = (e) => e, t) : (t2 = new FinalizationRegistry((e) => {
      e = e.Da, --e.count.value, e.count.value === 0 && (e.Ia ? e.Ka.Na(e.Ia) : e.Ga.Fa.Na(e.Ea));
    }), E1 = (e) => {
      var r = e.Da;
      return r.Ia && t2.register(e, { Da: r }, e), e;
    }, S2 = (e) => {
      t2.unregister(e);
    }, E1(t));
    function U1() {
    }
    var D1 = (t, e) => Object.defineProperty(e, "name", { value: t }), T2 = (t, e, r) => {
      if (t[e].Ha === void 0) {
        var a = t[e];
        t[e] = function(...o) {
          if (!t[e].Ha.hasOwnProperty(o.length)) throw new L(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ha})!`);
          return t[e].Ha[o.length].apply(this, o);
        }, t[e].Ha = [], t[e].Ha[a.Qa] = a;
      }
    }, e2 = (t, e, r) => {
      if (s.hasOwnProperty(t)) {
        if (r === void 0 || s[t].Ha !== void 0 && s[t].Ha[r] !== void 0) throw new L(`Cannot register public name '${t}' twice`);
        if (T2(s, t, t), s[t].Ha.hasOwnProperty(r)) throw new L(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        s[t].Ha[r] = e;
      } else s[t] = e, s[t].Qa = r;
    }, m3 = (t) => {
    ...
    function p3(t, e, r, a, o, l, c, u) {
      this.name = t, this.constructor = e, this.Pa = r, this.Na = a, this.Ja = o, this.fb = l, this.Ta = c, this.cb = u, this.mb = [];
    }
    var i2 = (t, e, r) => {
      for (; e !== r; ) {
        if (!e.Ta) throw new L(`Expected null or instance of ${r.name}, got an instance of ${e.name}`);
        t = e.Ta(t), e = e.Ja;
      }
      return t;
    };
    function g3(t, e) {
      if (e === null) {
        if (this.Wa) throw new L(`null is not a valid ${this.name}`);
        return 0;
      }
      if (!e.Da) throw new L(`Cannot pass "${l2(e)}" as a ${this.name}`);
      if (!e.Da.Ea) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return i2(e.Da.Ea, e.Da.Ga.Fa, this.Fa);
    }
    function y3(t, e) {
      if (e === null) {
        if (this.Wa) throw new L(`null is not a valid ${this.name}`);
        if (this.Va) {
          var r = this.Xa();
          return t !== null && t.push(this.Na, r), r;
        }
        return 0;
      }
      if (!e || !e.Da) throw new L(`Cannot pass "${l2(e)}" as a ${this.name}`);
      if (!e.Da.Ea) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ua && e.Da.Ga.Ua) throw new L(`Cannot convert argument of type ${e.Da.Ka ? e.Da.Ka.name : e.Da.Ga.name} to parameter type ${this.name}`);
      if (r = i2(e.Da.Ea, e.Da.Ga.Fa, this.Fa), this.Va) {
        if (e.Da.Ia === void 0) throw new L("Passing raw pointer to smart pointer is illegal");
        switch (this.rb) {
          case 0:
            if (e.Da.Ka === this) r = e.Da.Ia;
            else throw new L(`Cannot convert argument of type ${e.Da.Ka ? e.Da.Ka.name : e.Da.Ga.name} to parameter type ${this.name}`);
            break;
          case 1:
            r = e.Da.Ia;
            break;
          case 2:
            if (e.Da.Ka === this) r = e.Da.Ia;
              ...
              var a = e.clone();
              r = this.nb(r, j1(() => a.delete())), t !== null && t.push(this.Na, r);
            }
            break;
          default:
    ...
    function L3(t, e) {
      ...
      if (!e.Da) throw new L(`Cannot pass "${l2(e)}" as a ${this.name}`);
      if (!e.Da.Ea) throw new L(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Da.Ga.Ua) throw new L(`Cannot convert argument of type ${e.Da.Ga.name} to parameter type ${this.name}`);
      return i2(e.Da.Ea, e.Da.Ga.Fa, this.Fa);
    }
    function P1(t, e, r, a, o, l, c, u, f, v, _) {
      this.name = t, this.Fa = e, this.Wa = r, this.Ua = a, this.Va = o, this.lb = l, this.rb = c, this.ab = u, this.Xa = f, this.nb = v, this.Na = _, o || e.Ja !== void 0 ? this.toWireType = y3 : (this.toWireType = a ? g3 : L3, this.Ma = null);
    }
    var A2 = (t, e, r) => {
      if (!s.hasOwnProperty(t)) throw new I1("Replacing nonexistent public symbol");
      s[t].Ha !== void 0 && r !== void 0 ? s[t].Ha[r] = e : (s[t] = e, s[t].Qa = r);
    }, $, w3 = (t, e, r = []) => (t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, s["dynCall_" + t])(e, ...r)) : e = $.get(e)(...r), e), C3 = (t, e) => (...r) => w3(t, e, r), U = (t, e) => {
      t = R(t);
      var r = t.includes("j") ? C3(t, e) : $.get(e);
      if (typeof r != "function") throw new L(`unknown function pointer with signature ${t}: ${e}`);
      return r;
    }, R2, O2 = (t) => {
      t = N2(t);
      var e = R(t);
      ...
      function r(l) {
        o[l] || c1[l] || (W1[l] ? W1[l].forEach(r) : (a.push(l), o[l] = true));
      }
      var a = [], o = {};
      throw e.forEach(r), new R2(`${t}: ` + a.map(O2).join([", "]));
    }, n2 = (t, e) => {
      for (var r = [], a = 0; a < t; a++) r.push(w[e + 4 * a >> 2]);
      return r;
    };
    function M3(t) {
      for (var e = 1; e < t.length; ++e) if (t[e] !== null && t[e].Ma === void 0) return true;
      return false;
    }
    function r2(t, e, r, a, o) {
      var l = e.length;
      if (2 > l) throw new L("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var c = e[1] !== null && r !== null, u = M3(e), f = e[0].name !== "void", v = l - 2, _ = Array(v), g = [], b = [];
      return D1(t, function(...V) {
        if (b.length = 0, g.length = c ? 2 : 1, g[0] = o, c) {
          var F = e[1].toWireType(b, this);
          g[1] = F;
        }
        for (var T = 0; T < v; ++T) _[T] = e[T + 2].toWireType(b, V[T]), g.push(_[T]);
        if (V = a(...g), u) Y1(b);
        else for (T = c ? 1 : 2; T < e.length; T++) {
          var Y = T === 1 ? F : _[T - 2];
          e[T].Ma !== null && e[T].Ma(Y);
        }
        return F = f ? e[0].fromWireType(V) : void 0, F;
      });
    }
    var x2 = (t) => {
      t = t.trim();
      ...
      9 < t && --a1[t + 1] === 0 && (a1[t] = void 0, a2.push(t));
    }, s2 = (t) => {
      if (!t) throw new L("Cannot use deleted val. handle = " + t);
      return a1[t];
    }, j1 = (t) => {
      switch (t) {
        case void 0:
        ...
        case false:
          return 8;
        default:
          let e = a2.pop() || a1.length;
          return a1[e] = t, a1[e + 1] = 1, e;
      }
    }, W2 = { name: "emscripten::val", fromWireType: (t) => {
      var e = s2(t);
      return o2(t), e;
    }, toWireType: (t, e) => j1(e), La: 8, readValueFromPointer: b1, Ma: null }, b3 = (t, e, r) => {
      switch (e) {
        case 1:
          return r ? function(a) {
      ...
      var r = c1[t];
      if (r === void 0) throw t = `${e} has unknown type ${O2(t)}`, new L(t);
      return r;
    }, l2 = (t) => {
      ...
      switch (e) {
        ...
        case 8:
          return function(r) {
            return this.fromWireType(m1[r >> 3]);
          };
        default:
      ...
      switch (e) {
        case 1:
          return r ? (a) => Z[a] : (a) => S[a];
        case 2:
          return r ? (a) => t1[a >> 1] : (a) => z[a >> 1];
        case 4:
          return r ? (a) => K[a >> 2] : (a) => w[a >> 2];
        default:
          throw new TypeError(`invalid integer width (${e}): ${t}`);
      }
    }, D3 = Object.assign({ optional: true }, W2), $2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, P3 = (t, e) => {
      for (var r = t >> 1, a = r + e / 2; !(r >= a) && z[r]; ) ++r;
      if (r <<= 1, 32 < r - t && $2) return $2.decode(S.subarray(t, r));
      for (r = "", a = 0; !(a >= e / 2); ++a) {
        var o = t1[t + 2 * a >> 1];
        if (o == 0) break;
      ...
      for (var o = 0; o < r; ++o) t1[e >> 1] = t.charCodeAt(o), e += 2;
      return t1[e >> 1] = 0, e - a;
    }, F3 = (t) => 2 * t.length, k3 = (t, e) => {
      for (var r = 0, a = ""; !(r >= e / 4); ) {
        var o = K[t + 4 * r >> 2];
        if (o == 0) break;
      ...
      for (var o = 0; o < t.length; ++o) {
        ...
        if (K[e >> 2] = l, e += 4, e + 4 > r) break;
      }
      return K[e >> 2] = 0, e - a;
    }, A3 = (t) => {
      for (var e = 0, r = 0; r < t.length; ++r) {
        var a = t.charCodeAt(r);
        55296 <= a && 57343 >= a && ++r, e += 4;
      }
      return e;
    }, d2 = 0, u2 = [], R3 = (t) => {
      var e = u2.length;
      ...
      for (var r = Array(t), a = 0; a < t; ++a) r[a] = h2(w[e + 4 * a >> 2], "parameter " + a);
      return r;
    }, x3 = Reflect.construct, S1 = {}, U2 = (t) => {
      if (!(t instanceof I2 || t == "unwind")) throw t;
    }, z2 = (t) => {
      var e;
      throw s1 = t, Q1 || 0 < d2 || ((e = s.onExit) == null || e.call(s, t), l1 = true), new I2(t);
    }, W3 = (t) => {
      if (!l1) try {
        if (t(), !(Q1 || 0 < d2)) try {
          s1 = t = s1, z2(t);
      ...
      if (!f2) {
        var t = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: P || "./this.program" }, e;
        for (e in c2) c2[e] === void 0 ? delete t[e] : t[e] = c2[e];
        var r = [];
    ...
    I1 = s.InternalError = class extends Error {
      constructor(t) {
        super(t), this.name = "InternalError";
      }
    };
    for (var B2 = Array(256), H1 = 0; 256 > H1; ++H1) B2[H1] = String.fromCharCode(H1);
    P2 = B2, L = s.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Object.assign(U1.prototype, { isAliasOf: function(t) {
      if (!(this instanceof U1 && t instanceof U1)) return false;
      var e = this.Da.Ga.Fa, r = this.Da.Ea;
      t.Da = t.Da;
      var a = t.Da.Ga.Fa;
      for (t = t.Da.Ea; e.Ja; ) r = e.Ta(r), e = e.Ja;
      for (; a.Ja; ) t = a.Ta(t), a = a.Ja;
      return e === a && r === t;
    }, clone: function() {
      if (this.Da.Ea || Z1(this), this.Da.Sa) return this.Da.count.value += 1, this;
      var t = E1, e = Object, r = e.create, a = Object.getPrototypeOf(this), o = this.Da;
      return t = t(r.call(e, a, { Da: { value: { count: o.count, Ra: o.Ra, Sa: o.Sa, Ea: o.Ea, Ga: o.Ga, Ia: o.Ia, Ka: o.Ka } } })), t.Da.count.value += 1, t.Da.Ra = false, t;
    }, delete() {
      if (this.Da.Ea || Z1(this), this.Da.Ra && !this.Da.Sa) throw new L("Object already scheduled for deletion");
      S2(this);
      var t = this.Da;
      --t.count.value, t.count.value === 0 && (t.Ia ? t.Ka.Na(t.Ia) : t.Ga.Fa.Na(t.Ea)), this.Da.Sa || (this.Da.Ia = void 0, this.Da.Ea = void 0);
    }, isDeleted: function() {
      return !this.Da.Ea;
    }, deleteLater: function() {
      if (this.Da.Ea || Z1(this), this.Da.Ra && !this.Da.Sa) throw new L("Object already scheduled for deletion");
      return this.Da.Ra = true, this;
    } }), Object.assign(P1.prototype, { gb(t) {
      return this.ab && (t = this.ab(t)), t;
    }, Za(t) {
      var e;
      (e = this.Na) == null || e.call(this, t);
    }, La: 8, readValueFromPointer: b1, fromWireType: function(t) {
      function e() {
        return this.Va ? $1(this.Fa.Pa, { Ga: this.lb, Ea: r, Ka: this, Ia: t }) : $1(this.Fa.Pa, { Ga: this, Ea: t });
      }
      var r = this.gb(t);
      if (!r) return this.Za(t), null;
      var a = _3(this.Fa, r);
      if (a !== void 0) return a.Da.count.value === 0 ? (a.Da.Ea = r, a.Da.Ia = t, a.clone()) : (a = a.clone(), this.Za(t), a);
      if (a = this.Fa.fb(r), a = k2[a], !a) return e.call(this);
      a = this.Ua ? a.bb : a.pointerType;
      var o = F2(r, this.Fa, a.Fa);
      return o === null ? e.call(this) : this.Va ? $1(a.Fa.Pa, { Ga: a, Ea: o, Ka: this, Ia: t }) : $1(a.Fa.Pa, { Ga: a, Ea: o });
    } }), R2 = s.UnboundTypeError = ((t, e) => {
      var r = D1(e, function(a) {
        this.name = e, this.message = a, a = Error(a).stack, a !== void 0 && (this.stack = this.toString() + `
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
      });
      return r.prototype = Object.create(t.prototype), r.prototype.constructor = r, r.prototype.toString = function() {
        return this.message === void 0 ? this.name : `${this.name}: ${this.message}`;
      }, r;
    })(Error, "UnboundTypeError"), a1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), s.count_emval_handles = () => a1.length / 2 - 5 - a2.length;
    var z3 = { c: (t, e, r, a) => R1(`Assertion failed: ${t ? C1(S, t) : ""}, at: ` + [e ? e ? C1(S, e) : "" : "unknown filename", r, a ? a ? C1(S, a) : "" : "unknown function"]), d: () => c3(), p: (t, e, r) => {
      var a = new D2(t);
      throw w[a.Ea + 16 >> 2] = 0, w[a.Ea + 4 >> 2] = e, w[a.Ea + 8 >> 2] = r, g1 = t, g1;
    }, g: (t) => {
      throw g1 || (g1 = t), g1;
    }, R: () => {
    }, O: () => {
      ...
      var e = x1[t];
      delete x1[t];
      var r = e.Xa, a = e.Na, o = e.$a, l = o.map((c) => c.jb).concat(o.map((c) => c.pb));
      h1([t], l, (c) => {
        var u = {};
        return o.forEach((f, v) => {
          var _ = c[v], g = f.hb, b = f.ib, V = c[v + o.length], F = f.ob, T = f.qb;
          u[f.eb] = { read: (Y) => _.fromWireType(g(b, Y)), write: (Y, k1) => {
            var G = [];
            F(T, Y, V.toWireType(G, k1)), Y1(G);
          } };
        }), [{ name: e.name, fromWireType: (f) => {
          var v = {}, _;
          for (_ in u) v[_] = u[_].read(f);
          return a(f), v;
        }, toWireType: (f, v) => {
          for (var _ in u) if (!(_ in v)) throw new TypeError(`Missing field: "${_}"`);
          var g = r();
          for (_ in u) u[_].write(g, v[_]);
          return f !== null && f.push(a, g), g;
        }, La: 8, readValueFromPointer: b1, Ma: a }];
      });
    }, H: () => {
    }, aa: (t, e, r, a) => {
      e = R(e), Q(t, { name: e, fromWireType: function(o) {
        return !!o;
      }, toWireType: function(o, l) {
        return l ? r : a;
      }, La: 8, readValueFromPointer: function(o) {
        return this.fromWireType(S[o]);
      }, Ma: null });
    }, v: (t, e, r, a, o, l, c, u, f, v, _, g, b) => {
      _ = R(_), l = U(o, l), u && (u = U(c, u)), v && (v = U(f, v)), b = U(g, b);
      var V = m3(_);
      e2(V, function() {
        z1(`Cannot construct ${_} due to unbound types`, [a]);
      }), h1([t, e, r], a ? [a] : [], (F) => {
        if (F = F[0], a) var T = F.Fa, Y = T.Pa;
        else Y = U1.prototype;
        F = D1(_, function(..._2) {
          if (Object.getPrototypeOf(this) !== k1) throw new L("Use 'new' to construct " + _);
          if (G.Oa === void 0) throw new L(_ + " has no accessible constructor");
          var K2 = G.Oa[_2.length];
          if (K2 === void 0) throw new L(`Tried to invoke ctor of ${_} with invalid number of parameters (${_2.length}) - expected (${Object.keys(G.Oa).toString()}) parameters instead!`);
          return K2.apply(this, _2);
        });
        var k1 = Object.create(Y, { constructor: { value: F } });
        F.prototype = k1;
        var G = new p3(_, F, k1, b, T, l, u, v);
        if (G.Ja) {
          var T1;
          (T1 = G.Ja).Ya != null || (T1.Ya = []), G.Ja.Ya.push(G);
        }
        return T = new P1(_, G, true, false, false), T1 = new P1(_ + "*", G, false, false, false), Y = new P1(_ + " const*", G, false, true, false), k2[t] = { pointerType: T1, bb: Y }, A2(V, F), [T, T1, Y];
      });
    }, t: (t, e, r, a, o, l) => {
      var c = n2(e, r);
      o = U(a, o), h1([], [t], (u) => {
        ...
        if (u.Fa.Oa === void 0 && (u.Fa.Oa = []), u.Fa.Oa[e - 1] !== void 0) throw new L(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${u.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return u.Fa.Oa[e - 1] = () => {
          z1(`Cannot construct ${u.name} due to unbound types`, c);
        }, h1([], c, (v) => (v.splice(1, 0, null), u.Fa.Oa[e - 1] = r2(f, v, null, o, l), [])), [];
      });
    }, h: (t, e, r, a, o, l, c, u) => {
      var f = n2(r, a);
      e = R(e), e = x2(e), l = U(o, l), h1([], [t], (v) => {
        function _() {
          z1(`Cannot call ${g} due to unbound types`, f);
        }
        v = v[0];
        var g = `${v.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), u && v.Fa.mb.push(e);
        var b = v.Fa.Pa, V = b[e];
        return V === void 0 || V.Ha === void 0 && V.className !== v.name && V.Qa === r - 2 ? (_.Qa = r - 2, _.className = v.name, b[e] = _) : (T2(b, e, g), b[e].Ha[r - 2] = _), h1([], f, (F) => (F = r2(g, F, v, l, c), b[e].Ha === void 0 ? (F.Qa = r - 2, b[e] = F) : b[e].Ha[r - 2] = F, [])), [];
      });
    }, $: (t) => Q(t, W2), B: (t, e, r, a) => {
      function o() {
      }
      e = R(e), o.values = {}, Q(t, { name: e, constructor: o, fromWireType: function(l) {
        return this.constructor.values[l];
      }, toWireType: (l, c) => c.value, La: 8, readValueFromPointer: b3(e, r, a), Ma: null }), e2(e, o);
    }, n: (t, e, r) => {
      var a = h2(t, "enum");
      e = R(e), t = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: D1(`${a.name}_${e}`, function() {
      }) } }), t.values[r] = a, t[e] = a;
    }, D: (t, e, r) => {
      e = R(e), Q(t, { name: e, fromWireType: (a) => a, toWireType: (a, o) => o, La: 8, readValueFromPointer: I3(e, r), Ma: null });
    }, y: (t, e, r, a, o, l) => {
      var c = n2(e, r);
      t = R(t), t = x2(t), o = U(a, o), e2(t, function() {
        z1(`Cannot call ${t} due to unbound types`, c);
      }, e - 1), h1([], c, (u) => (A2(t, r2(t, [u[0], null].concat(u.slice(1)), null, o, l), e - 1), []));
    }, o: (t, e, r, a, o) => {
      if (e = R(e), o === -1 && (o = 4294967295), o = (u) => u, a === 0) {
        var l = 32 - 8 * r;
        o = (u) => u << l >>> l;
      }
      var c = e.includes("unsigned") ? function(u, f) {
        return f >>> 0;
      } : function(u, f) {
        return f;
      };
      Q(t, { name: e, fromWireType: o, toWireType: c, La: 8, readValueFromPointer: E3(e, r, a !== 0), Ma: null });
    }, k: (t, e, r) => {
      function a(l) {
        return new o(Z.buffer, w[l + 4 >> 2], w[l >> 2]);
      }
      var o = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][e];
      r = R(r), Q(t, { name: r, fromWireType: a, La: 8, readValueFromPointer: a }, { kb: true });
    }, x: (t) => {
      Q(t, D3);
    }, ga: (t, e, r, a, o, l, c, u, f, v, _, g) => {
      r = R(r), l = U(o, l), u = U(c, u), v = U(f, v), g = U(_, g), h1([t], [e], (b) => (b = b[0], [new P1(r, b.Fa, false, false, true, b, a, l, u, v, g)]));
    }, E: (t, e) => {
      e = R(e);
      var r = e === "std::string";
      Q(t, { name: e, fromWireType: function(a) {
        var o = w[a >> 2], l = a + 4;
        if (r) for (var c = l, u = 0; u <= o; ++u) {
          var f = l + u;
          if (u == o || S[f] == 0) {
            if (c = c ? C1(S, c, f - c) : "", v === void 0) var v = c;
            else v += "\0", v += c;
            c = f + 1;
          }
        }
        else {
          for (v = Array(o), u = 0; u < o; ++u) v[u] = String.fromCharCode(S[l + u]);
          v = v.join("");
        }
        return o1(a), v;
        ...
        if (!(c || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array)) throw new L("Cannot pass non-string to std::string");
        if (r && c) for (var u = l = 0; u < o.length; ++u) {
          var f = o.charCodeAt(u);
          127 >= f ? l++ : 2047 >= f ? l += 2 : 55296 <= f && 57343 >= f ? (l += 4, ++u) : l += 3;
        }
        else l = o.length;
        if (u = v2(4 + l + 1), f = u + 4, w[u >> 2] = l, r && c) M1(o, f, l + 1);
        else if (c) for (c = 0; c < l; ++c) {
          var v = o.charCodeAt(c);
          if (255 < v) throw o1(f), new L("String has UTF-16 code units that do not fit in 8 bits");
          S[f + c] = v;
        }
        else for (c = 0; c < l; ++c) S[f + c] = o[c];
        return a !== null && a.push(o1, u), u;
      }, La: 8, readValueFromPointer: b1, Ma(a) {
        o1(a);
      } });
    }, w: (t, e, r) => {
      if (r = R(r), e === 2) var a = P3, o = S3, l = F3, c = (u) => z[u >> 1];
      else e === 4 && (a = k3, o = T3, l = A3, c = (u) => w[u >> 2]);
      Q(t, { name: r, fromWireType: (u) => {
        for (var f = w[u >> 2], v, _ = u + 4, g = 0; g <= f; ++g) {
          var b = u + 4 + g * e;
          (g == f || c(b) == 0) && (_ = a(_, b - _), v === void 0 ? v = _ : (v += "\0", v += _), _ = b + e);
        }
        return o1(u), v;
      }, toWireType: (u, f) => {
        if (typeof f != "string") throw new L(`Cannot pass non-string to C++ string type ${r}`);
        var v = l(f), _ = v2(4 + v + e);
        return w[_ >> 2] = v / e, o(f, _ + 4, v + e), u !== null && u.push(o1, _), _;
      }, La: 8, readValueFromPointer: b1, Ma(u) {
        o1(u);
      } });
    }, A: (t, e, r, a, o, l) => {
      x1[t] = { name: R(e), Xa: U(r, a), Na: U(o, l), $a: [] };
    }, m: (t, e, r, a, o, l, c, u, f, v) => {
      x1[t].$a.push({ eb: R(e), jb: r, hb: U(a, o), ib: l, pb: c, ob: U(u, f), qb: v });
    }, ba: (t, e) => {
      e = R(e), Q(t, { sb: true, name: e, La: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, M: () => {
      Q1 = false, d2 = 0;
      ...
      throw 1 / 0;
    }, ea: (t, e, r, a) => (t = u2[t], e = s2(e), t(null, e, r, a)), F: o2, da: (t, e, r) => {
      var a = O3(t, e), o = a.shift();
      t--;
      var l = Array(t);
      return e = `methodCaller<(${a.map((c) => c.name).join(", ")}) => ${o.name}>`, R3(D1(e, (c, u, f, v) => {
        for (var _ = 0, g = 0; g < t; ++g) l[g] = a[g].readValueFromPointer(v + _), _ += a[g].La;
        return u = r === 1 ? x3(u, l) : u.apply(c, l), c = [], u = o.toWireType(c, u), c.length && (w[f >> 2] = j1(c)), u;
      }));
    }, fa: (t) => {
      9 < t && (a1[t + 1] += 1);
    }, ca: (t) => {
      var e = s2(t);
      Y1(e), o2(t);
    }, r: (t, e) => (t = h2(t, "_emval_take_value"), t = t.readValueFromPointer(e), j1(t)), J: (t, e) => {
      if (S1[t] && (clearTimeout(S1[t].id), delete S1[t]), !e) return 0;
      var r = setTimeout(() => {
        delete S1[t], W3(() => J2(t, performance.now()));
      }, e);
      return S1[t] = { id: r, tb: e }, 0;
    }, K: (t, e, r, a) => {
      var o = (/* @__PURE__ */ new Date()).getFullYear(), l = new Date(o, 0, 1).getTimezoneOffset();
      o = new Date(o, 6, 1).getTimezoneOffset(), w[t >> 2] = 60 * Math.max(l, o), K[e >> 2] = +(l != o), e = (c) => {
        var u = Math.abs(c);
        return `UTC${0 <= c ? "-" : "+"}${String(Math.floor(u / 60)).padStart(2, "0")}${String(u % 60).padStart(2, "0")}`;
      }, t = e(l), e = e(o), o < l ? (M1(t, r, 17), M1(e, a, 17)) : (M1(t, a, 17), M1(e, r, 17));
    }, ha: () => performance.now(), L: (t) => {
      var e = S.length;
      if (t >>>= 0, 2147483648 < t) return false;
      for (var r = 1; 4 >= r; r *= 2) {
        var a = e * (1 + 0.2 / r);
        a = Math.min(a, t + 100663296);
        t: {
          a = (Math.min(2147483648, 65536 * Math.ceil(Math.max(t, a) / 65536)) - _1.buffer.byteLength + 65535) / 65536 | 0;
          try {
            _1.grow(a), L1();
            var o = 1;
            break t;
      ...
      var r = 0;
      return j2().forEach((a, o) => {
        var l = e + r;
        for (o = w[t + 4 * o >> 2] = l, l = 0; l < a.length; ++l) Z[o++] = a.charCodeAt(l);
        Z[o] = 0, r += a.length + 1;
      }), 0;
    }, Z: (t, e) => {
      var r = j2();
      w[t >> 2] = r.length;
      var a = 0;
      return r.forEach((o) => a += o.length + 1), w[e >> 2] = a, 0;
    }, V: () => 52, T: () => 52, S: (t, e, r, a) => {
      for (var o = 0, l = 0; l < r; l++) {
        var c = w[e >> 2], u = w[e + 4 >> 2];
        e += 8;
        for (var f = 0; f < u; f++) {
          var v = t, _ = S[c + f], g = $3[v];
          _ === 0 || _ === 10 ? ((v === 1 ? q : J)(C1(g)), g.length = 0) : g.push(_);
        }
        o += u;
      }
      return w[a >> 2] = o, 0;
    }, j: V3, f: Q3, e: X3, _: H3, s: Y3, C: K3, u: J3, b: j3, a: B3, i: N3, l: q3, q: G3, G: Z3, X: z2, N: (t, e) => (H2(S.subarray(t, t + e)), 0) }, E = function() {
      var t;
      function e(a) {
        var o;
        return E = a.exports, _1 = E.ia, L1(), $ = E.na, A1.unshift(E.ja), u1--, (o = s.monitorRunDependencies) == null || o.call(s, u1), u1 == 0 && w1 && (a = w1, w1 = null, a()), E;
      }
      u1++, (t = s.monitorRunDependencies) == null || t.call(s, u1);
      var r = { a: z3 };
      if (s.instantiateWasm) try {
        return s.instantiateWasm(r, e);
      } catch (a) {
        J(`Module.instantiateWasm callback failed with error: ${a}`), M(a);
      }
      return O1 != null || (O1 = C2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : s.locateFile ? s.locateFile("DotLottiePlayer.wasm", A) : A + "DotLottiePlayer.wasm"), u3(r, function(a) {
        e(a.instance);
      }).catch(M), {};
    }(), v2 = (t) => (v2 = E.ka)(t), N2 = (t) => (N2 = E.la)(t), o1 = (t) => (o1 = E.ma)(t), J2 = (t, e) => (J2 = E.oa)(t, e), j = (t, e) => (j = E.pa)(t, e), F1 = (t) => (F1 = E.qa)(t), H = (t) => (H = E.ra)(t), B = () => (B = E.sa)(), V2 = (t, e, r) => (V2 = E.ta)(t, e, r);
    s.dynCall_iijj = (t, e, r, a, o, l) => (s.dynCall_iijj = E.ua)(t, e, r, a, o, l), s.dynCall_vijj = (t, e, r, a, o, l) => (s.dynCall_vijj = E.va)(t, e, r, a, o, l), s.dynCall_jiii = (t, e, r, a) => (s.dynCall_jiii = E.wa)(t, e, r, a);
    var G2 = s.dynCall_vijjjj = (t, e, r, a, o, l, c, u, f, v) => (G2 = s.dynCall_vijjjj = E.xa)(t, e, r, a, o, l, c, u, f, v);
    s.dynCall_jii = (t, e, r) => (s.dynCall_jii = E.ya)(t, e, r), s.dynCall_viijii = (t, e, r, a, o, l, c) => (s.dynCall_viijii = E.za)(t, e, r, a, o, l, c), s.dynCall_iiiiij = (t, e, r, a, o, l, c) => (s.dynCall_iiiiij = E.Aa)(t, e, r, a, o, l, c), s.dynCall_iiiiijj = (t, e, r, a, o, l, c, u, f) => (s.dynCall_iiiiijj = E.Ba)(t, e, r, a, o, l, c, u, f), s.dynCall_iiiiiijj = (t, e, r, a, o, l, c, u, f, v) => (s.dynCall_iiiiiijj = E.Ca)(t, e, r, a, o, l, c, u, f, v);
    function j3(t, e) {
      var r = B();
      try {
        $.get(t)(e);
      } catch (a) {
        if (H(r), a !== a + 0) throw a;
        j(1, 0);
      }
    }
    function H3(t, e, r, a, o) {
      var l = B();
      try {
        return $.get(t)(e, r, a, o);
      } catch (c) {
    ...
    function G3(t, e, r, a, o, l) {
      var c = B();
      try {
        $.get(t)(e, r, a, o, l);
      } catch (u) {
        if (H(c), u !== u + 0) throw u;
        j(1, 0);
      }
    }
    function q3(t, e, r, a, o) {
      var l = B();
      try {
        $.get(t)(e, r, a, o);
      } catch (c) {
    ...
    function K3(t, e, r, a, o, l, c, u) {
      var f = B();
      try {
        return $.get(t)(e, r, a, o, l, c, u);
      } catch (v) {
        if (H(f), v !== v + 0) throw v;
        j(1, 0);
      }
    }
    function X3(t, e, r, a) {
    ...
    function Y3(t, e, r, a, o, l) {
      var c = B();
      try {
        return $.get(t)(e, r, a, o, l);
      } catch (u) {
        if (H(c), u !== u + 0) throw u;
        j(1, 0);
      }
    }
    function Z3(t, e, r, a, o, l, c, u, f, v) {
      var _ = B();
      try {
        G2(t, e, r, a, o, l, c, u, f, v);
      } catch (g) {
        if (H(_), g !== g + 0) throw g;
        j(1, 0);
      }
    }
    var B1;
    ...
    function q2() {
      function t() {
        var e;
        if (!B1 && (B1 = true, s.calledRun = true, !l1)) {
          if (X1(A1), m(s), (e = s.onRuntimeInitialized) == null || e.call(s), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
            var r = s.postRun.shift();
            X.unshift(r);
          }
          X1(X);
        }
      ...
      if (!(0 < u1)) {
        if (s.preRun) for (typeof s.preRun == "function" && (s.preRun = [s.preRun]); s.preRun.length; ) p1();
        X1(d1), 0 < u1 || (s.setStatus ? (s.setStatus("Running..."), setTimeout(() => {
...
var J1 = class {
  ...
  static _tryLoad(d) {
    return y(this, null, function* () {
      return yield l0({ locateFile: () => d });
    });
  }
  static _loadWithBackup() {
    return y(this, null, function* () {
      return this._ModulePromise || (this._ModulePromise = this._tryLoad(this._wasmURL).catch((d) => y(this, null, function* () {
        let i = `https://unpkg.com/${a3}@${r3}/dist/dotlottie-player.wasm`;
        console.warn(`Primary WASM load failed from ${this._wasmURL}. Error: ${d.message}`), console.warn(`Attempting to load WASM from backup URL: ${i}`);
        try {
          return yield this._tryLoad(i);
        } catch (n) {
          throw console.error(`Primary WASM URL failed: ${d.message}`), console.error(`Backup WASM URL failed: ${n.message}`), new Error("WASM loading failed from all sources.");
        }
      }))), this._ModulePromise;
    });
  }
  ...
  static setWasmUrl(d) {
    d !== this._wasmURL && (this._wasmURL = d, this._ModulePromise = null);
  }
};
p(J1, "_ModulePromise", null), p(J1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${a3}@${r3}/dist/dotlottie-player.wasm`);
var o3 = class {
  constructor() {
    p(this, "_eventListeners", /* @__PURE__ */ new Map());
  }
  addEventListener(d, i) {
    let n = this._eventListeners.get(d);
    n || (n = /* @__PURE__ */ new Set(), this._eventListeners.set(d, n)), n.add(i);
  }
  removeEventListener(d, i) {
    let n = this._eventListeners.get(d);
    n && (i ? (n.delete(i), n.size === 0 && this._eventListeners.delete(d)) : this._eventListeners.delete(d));
  }
  dispatch(d) {
    let i = this._eventListeners.get(d.type);
    i == null ? void 0 : i.forEach((n) => n(d));
  }
...
var e1 = class {
  static _initializeObserver() {
    ...
    let d = (i) => {
      i.forEach((n) => {
        let h = this._observedCanvases.get(n.target);
        h && (n.isIntersecting ? h.unfreeze() : h.freeze());
      });
    };
    this._observer = new IntersectionObserver(d, { threshold: 0 });
  }
  static observe(d, i) {
    var n;
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, i), (n = this._observer) == null || n.observe(d));
  }
  static unobserve(d) {
    var i, n;
    (i = this._observer) == null || i.unobserve(d), this._observedCanvases.delete(d), this._observedCanvases.size === 0 && ((n = this._observer) == null || n.disconnect(), this._observer = null);
  }
};
p(e1, "_observer", null), p(e1, "_observedCanvases", /* @__PURE__ */ new Map());
var i1 = class {
  static _initializeObserver() {
    if (this._observer) return;
    let d = (i) => {
      i.forEach((n) => {
        ...
        this._observedCanvases.set(n.target, [s, M]);
      });
    };
  ...
  static observe(d, i) {
    var n;
    this._initializeObserver(), !this._observedCanvases.has(d) && (this._observedCanvases.set(d, [i, 0]), (n = this._observer) == null || n.observe(d));
  }
  static unobserve(d) {
    var i, n;
    (i = this._observer) == null || i.unobserve(d), this._observedCanvases.delete(d), this._observedCanvases.size === 0 && ((n = this._observer) == null || n.disconnect(), this._observer = null);
...
p(i1, "_observer", null), p(i1, "_observedCanvases", /* @__PURE__ */ new Map());
function d0(d) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(d);
}
function u0(d) {
  if (!d0(d)) return 0;
  let i = d.replace("#", "");
  return i = i.length === 6 ? `${i}ff` : i, parseInt(i, 16);
}
function X2(d) {
  if (d.byteLength < 4) return false;
  let i = new Uint8Array(d.slice(0, m2.byteLength));
  for (let n = 0; n < m2.length; n += 1) if (m2[n] !== i[n]) return false;
  return true;
}
function Q2(d) {
  return o0.every((i) => Object.prototype.hasOwnProperty.call(d, i));
}
function Y2(d) {
  if (typeof d == "string") try {
    return Q2(JSON.parse(d));
  } catch {
    return false;
  }
  else return Q2(d);
...
function v1() {
  return 1 + ((W ? window.devicePixelRatio : 1) - 1) * s0;
}
function s3(d) {
...
var p2 = (d, i) => d === "reverse" ? i.Mode.Reverse : d === "bounce" ? i.Mode.Bounce : d === "reverse-bounce" ? i.Mode.ReverseBounce : i.Mode.Forward;
var c0 = (d, i) => d === "contain" ? i.Fit.Contain : d === "cover" ? i.Fit.Cover : d === "fill" ? i.Fit.Fill : d === "fit-height" ? i.Fit.FitHeight : d === "fit-width" ? i.Fit.FitWidth : i.Fit.None;
var f0 = (d, i) => {
  let n = new i.VectorFloat();
  return n.push_back(d[0]), n.push_back(d[1]), n;
};
var g2 = (d, i) => {
  let n = new i.VectorFloat();
  return d.length !== 2 || (n.push_back(d[0]), n.push_back(d[1])), n;
};
var y2 = (d, i) => {
  var n, h;
  return d ? { align: f0((n = d.align) != null ? n : [0.5, 0.5], i), fit: c0((h = d.fit) != null ? h : "contain", i) } : i.createDefaultLayout();
};
var h3 = class D {
  constructor(i) {
    p(this, "_canvas"), p(this, "_context", null), p(this, "_eventManager"), p(this, "_animationFrameId", null), p(this, "_frameManager"), p(this, "_dotLottieCore", null), p(this, "_renderConfig", {}), p(this, "_isFrozen", false), p(this, "_backgroundColor", null), p(this, "_pointerUpMethod"), p(this, "_pointerDownMethod"), p(this, "_pointerMoveMethod"), p(this, "_pointerEnterMethod"), p(this, "_pointerExitMethod");
    var n, h, s;
    this._canvas = i.canvas, this._context = this._canvas.getContext("2d"), this._eventManager = new o3(), this._frameManager = new a0(), this._renderConfig = N(O({}, i.renderConfig), { devicePixelRatio: ((n = i.renderConfig) == null ? void 0 : n.devicePixelRatio) || v1(), freezeOnOffscreen: (s = (h = i.renderConfig) == null ? void 0 : h.freezeOnOffscreen) != null ? s : true }), J1.load().then((m) => {
      var M, C, I, P, A, n1, q, J;
      D._wasmModule = m, this._dotLottieCore = new m.DotLottiePlayer({ themeId: (M = i.themeId) != null ? M : "", autoplay: (C = i.autoplay) != null ? C : false, backgroundColor: 0, loopAnimation: (I = i.loop) != null ? I : false, mode: p2((P = i.mode) != null ? P : "forward", m), segment: g2((A = i.segment) != null ? A : [], m), speed: (n1 = i.speed) != null ? n1 : 1, useFrameInterpolation: (q = i.useFrameInterpolation) != null ? q : true, marker: (J = i.marker) != null ? J : "", layout: y2(i.layout, m) }), this._eventManager.dispatch({ type: "ready" }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), i.backgroundColor && this.setBackgroundColor(i.backgroundColor);
    }).catch((m) => {
  ...
  _dispatchError(i) {
    console.error(i), this._eventManager.dispatch({ type: "loadError", error: new Error(i) });
  }
  _fetchData(i) {
    return y(this, null, function* () {
      let n = yield fetch(i);
      if (!n.ok) throw new Error(`Failed to fetch animation data from URL: ${i}. ${n.status}: ${n.statusText}`);
      let h = yield n.arrayBuffer();
      return X2(h) ? h : new TextDecoder().decode(h);
    });
  }
  _loadFromData(i) {
    if (this._dotLottieCore === null) return;
    let n = this._canvas.width, h = this._canvas.height, s = false;
    if (typeof i == "string") {
      if (!Y2(i)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      s = this._dotLottieCore.loadAnimationData(i, n, h);
  ...
  get layout() {
    ...
    if (n) return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
      var h, s, m, M, C, I;
      switch (n.fit) {
        case ((h = D._wasmModule) == null ? void 0 : h.Fit.Contain):
          return "contain";
        case ((s = D._wasmModule) == null ? void 0 : s.Fit.Cover):
          return "cover";
        case ((m = D._wasmModule) == null ? void 0 : m.Fit.Fill):
          return "fill";
        case ((M = D._wasmModule) == null ? void 0 : M.Fit.FitHeight):
          return "fit-height";
        case ((C = D._wasmModule) == null ? void 0 : C.Fit.FitWidth):
          return "fit-width";
        case ((I = D._wasmModule) == null ? void 0 : I.Fit.None):
          return "none";
        default:
          return "contain";
      }
  ...
  get manifest() {
    var i;
    try {
      let n = (i = this._dotLottieCore) == null ? void 0 : i.manifestString();
  ...
  get loop() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.config().loopAnimation) != null ? n : false;
  }
  get mode() {
    var i, n, h, s;
    let m = (i = this._dotLottieCore) == null ? void 0 : i.config().mode;
    return m === ((n = D._wasmModule) == null ? void 0 : n.Mode.Reverse) ? "reverse" : m === ((h = D._wasmModule) == null ? void 0 : h.Mode.Bounce) ? "bounce" : m === ((s = D._wasmModule) == null ? void 0 : s.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  get backgroundColor() {
    var i;
    return (i = this._backgroundColor) != null ? i : "";
  }
  get autoplay() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.config().autoplay) != null ? n : false;
  }
  get useFrameInterpolation() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.config().useFrameInterpolation) != null ? n : false;
  }
  get speed() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.config().speed) != null ? n : 0;
  }
  get isReady() {
  ...
  get isLoaded() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.isLoaded()) != null ? n : false;
  }
  get isPlaying() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.isPlaying()) != null ? n : false;
  }
  get isPaused() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.isPaused()) != null ? n : false;
  }
  get isStopped() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.isStopped()) != null ? n : false;
  }
  get currentFrame() {
  ...
  get loopCount() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.loopCount()) != null ? n : 0;
  }
  get totalFrames() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.totalFrames()) != null ? n : 0;
  }
  get duration() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.duration()) != null ? n : 0;
  }
  get segmentDuration() {
    var i, n;
    return (n = (i = this._dotLottieCore) == null ? void 0 : i.segmentDuration()) != null ? n : 0;
  }
  get canvas() {
    return this._canvas;
  }
  load(i) {
    var n, h, s, m, M, C, I, P, A;
    this._dotLottieCore === null || D._wasmModule === null || (this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), this._isFrozen = false, this._dotLottieCore.setConfig({ themeId: (n = i.themeId) != null ? n : "", autoplay: (h = i.autoplay) != null ? h : false, backgroundColor: 0, loopAnimation: (s = i.loop) != null ? s : false, mode: p2((m = i.mode) != null ? m : "forward", D._wasmModule), segment: g2((M = i.segment) != null ? M : [], D._wasmModule), speed: (C = i.speed) != null ? C : 1, useFrameInterpolation: (I = i.useFrameInterpolation) != null ? I : true, marker: (P = i.marker) != null ? P : "", layout: y2(i.layout, D._wasmModule) }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor((A = i.backgroundColor) != null ? A : ""));
  }
  _render() {
    if (this._dotLottieCore === null || this._context === null) return false;
    if (this._dotLottieCore.render()) {
      let i = this._dotLottieCore.buffer(), n = new Uint8ClampedArray(i, 0, this._canvas.width * this._canvas.height * 4), h = null;
      return typeof ImageData > "u" ? (h = this._context.createImageData(this._canvas.width, this._canvas.height), h.data.set(n)) : h = new ImageData(n, this._canvas.width, this._canvas.height), this._context.putImageData(h, 0, 0), this._eventManager.dispatch({ type: "render", currentFrame: this.currentFrame }), true;
    }
    return false;
  }
  _draw() {
    if (!(this._dotLottieCore === null || this._context === null || !this._dotLottieCore.isPlaying())) try {
      let i = Math.round(this._dotLottieCore.requestFrame() * 1e3) / 1e3;
      if (this._dotLottieCore.setFrame(i) && (this._eventManager.dispatch({ type: "frame", currentFrame: this.currentFrame }), this._render() && this._dotLottieCore.isComplete())) if (this._dotLottieCore.config().loopAnimation) this._eventManager.dispatch({ type: "loop", loopCount: this._dotLottieCore.loopCount() });
      else {
  ...
  setFrame(i) {
    this._dotLottieCore === null || i < 0 || i > this._dotLottieCore.totalFrames() || this._dotLottieCore.seek(i) && (this._eventManager.dispatch({ type: "frame", currentFrame: this.currentFrame }), this._render());
  }
  setSpeed(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { speed: i }));
  }
  setBackgroundColor(i) {
    this._dotLottieCore !== null && (W && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { backgroundColor: u0(i) })), this._backgroundColor = i);
  }
  setLoop(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { loopAnimation: i }));
  }
  setUseFrameInterpolation(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { useFrameInterpolation: i }));
  }
  addEventListener(i, n) {
    this._eventManager.addEventListener(i, n);
  }
  removeEventListener(i, n) {
    this._eventManager.removeEventListener(i, n);
  }
  destroy() {
    var i;
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), W && this._canvas instanceof HTMLCanvasElement && (e1.unobserve(this._canvas), i1.unobserve(this._canvas)), (i = this._dotLottieCore) == null || i.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded)) {
      if (W && this._canvas instanceof HTMLCanvasElement) {
        let i = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: n, width: h } = this._canvas.getBoundingClientRect();
        n !== 0 && h !== 0 && (this._canvas.width = h * i, this._canvas.height = n * i);
      }
      this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && this._render();
    }
  }
  setSegment(i, n) {
    this._dotLottieCore === null || D._wasmModule === null || this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { segment: g2([i, n], D._wasmModule) }));
  }
  setMode(i) {
    this._dotLottieCore === null || D._wasmModule === null || this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { mode: p2(i, D._wasmModule) }));
  }
  setRenderConfig(i) {
    let n = i, { devicePixelRatio: h, freezeOnOffscreen: s } = n, m = n3(n, ["devicePixelRatio", "freezeOnOffscreen"]);
    this._renderConfig = N(O(O({}, this._renderConfig), m), { devicePixelRatio: h || v1(), freezeOnOffscreen: s ?? true }), W && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? i1.observe(this._canvas, this) : i1.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? e1.observe(this._canvas, this) : (e1.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
    this._dotLottieCore === null || this._dotLottieCore.activeAnimationId() === i || (this._dotLottieCore.loadAnimation(i, this._canvas.width, this._canvas.height) ? (this._eventManager.dispatch({ type: "load" }), this.resize()) : this._eventManager.dispatch({ type: "loadError", error: new Error(`Failed to animation :${i}`) }));
  }
  setMarker(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { marker: i }));
  }
  markers() {
    var i;
    ...
    if (n) {
      ...
      for (let s = 0; s < n.size(); s += 1) {
        let m = n.get(s);
        h.push({ name: m.name, time: m.time, duration: m.duration });
      }
      return h;
    }
    return [];
  ...
  setTheme(i) {
    ...
    let n = this._dotLottieCore.setTheme(i);
  ...
  setThemeData(i) {
    if (this._dotLottieCore === null) return false;
    let n = this._dotLottieCore.setThemeData(i);
    return this._render(), n;
  }
  setSlots(i) {
    this._dotLottieCore !== null && this._dotLottieCore.setSlots(i);
  }
  setLayout(i) {
    this._dotLottieCore === null || D._wasmModule === null || this._dotLottieCore.setConfig(N(O({}, this._dotLottieCore.config()), { layout: y2(i, D._wasmModule) }));
  }
  setViewport(i, n, h, s) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(i, n, h, s);
  }
  static setWasmUrl(i) {
    J1.setWasmUrl(i);
  }
...
var m0 = class {
  constructor() {
    p(this, "_workers", /* @__PURE__ */ new Map()), p(this, "_animationWorkerMap", /* @__PURE__ */ new Map());
  }
  getWorker(d) {
    return this._workers.has(d) || this._workers.set(d, new _0()), this._workers.get(d);
  }
  assignAnimationToWorker(d, i) {
    this._animationWorkerMap.set(d, i);
  }
  unassignAnimationFromWorker(d) {
    this._animationWorkerMap.delete(d);
  }
  sendMessage(d, i, n) {
    this.getWorker(d).postMessage(i, n || []);
  }
  terminateWorker(d) {
    let i = this._workers.get(d);
    i && (i.terminate(), this._workers.delete(d));
  }
};
function Z2(d, i) {
  if (d instanceof HTMLCanvasElement) {
    let { height: n, width: h } = d.getBoundingClientRect();
    if (n !== 0 && h !== 0) return { width: h * i, height: n * i };
  }
...
var w2 = class f1 {
  ...
  _create(i) {
    return y(this, null, function* () {
      var n;
      let h;
      this._canvas instanceof HTMLCanvasElement ? h = this._canvas.transferControlToOffscreen() : h = this._canvas;
      let { instanceId: s } = yield this._sendMessage("create", O({ instanceId: this._id, config: N(O({}, i), { canvas: h }) }, Z2(this._canvas, ((n = i.renderConfig) == null ? void 0 : n.devicePixelRatio) || v1())), [h]);
  ...
  play() {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("play", { instanceId: this._id }), yield this._updateDotLottieInstanceState(), W && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !s3(this._canvas) && (yield this.freeze()));
    });
  }
  pause() {
    return y(this, null, function* () {
  ...
  setSpeed(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setSpeed", { instanceId: this._id, speed: i }), yield this._updateDotLottieInstanceState());
    });
  }
  setMode(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setMode", { instanceId: this._id, mode: i }), yield this._updateDotLottieInstanceState());
    });
  }
  setFrame(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setFrame", { frame: i, instanceId: this._id }), yield this._updateDotLottieInstanceState());
    });
  }
  setSegment(i, n) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setSegment", { instanceId: this._id, segment: [i, n] }), yield this._updateDotLottieInstanceState());
    });
  }
  setRenderConfig(i) {
    return y(this, null, function* () {
      ...
      let n = i, { devicePixelRatio: h, freezeOnOffscreen: s } = n, m = n3(n, ["devicePixelRatio", "freezeOnOffscreen"]);
      yield this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: N(O(O({}, this._dotLottieInstanceState.renderConfig), m), { devicePixelRatio: h || v1(), freezeOnOffscreen: s ?? true }) }), yield this._updateDotLottieInstanceState(), W && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? i1.observe(this._canvas, this) : i1.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? e1.observe(this._canvas, this) : (e1.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && (yield this.unfreeze())));
    });
  }
  setUseFrameInterpolation(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setUseFrameInterpolation", { instanceId: this._id, useFrameInterpolation: i }), yield this._updateDotLottieInstanceState());
    });
  }
  setTheme(i) {
    return y(this, null, function* () {
      if (!this._created) return false;
      let n = this._sendMessage("setTheme", { instanceId: this._id, themeId: i });
      return yield this._updateDotLottieInstanceState(), n;
    });
  }
  load(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("load", { config: i, instanceId: this._id }), yield this._updateDotLottieInstanceState());
    });
  }
  setLoop(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setLoop", { instanceId: this._id, loop: i }), yield this._updateDotLottieInstanceState());
    });
  }
  resize() {
    return y(this, null, function* () {
      if (!this._created) return;
      let { height: i, width: n } = Z2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || v1());
      yield this._sendMessage("resize", { height: i, instanceId: this._id, width: n }), yield this._updateDotLottieInstanceState();
    });
  }
  destroy() {
    return y(this, null, function* () {
      this._created && (this._created = false, yield this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), f1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), W && this._canvas instanceof HTMLCanvasElement && (e1.unobserve(this._canvas), i1.unobserve(this._canvas)));
    });
  }
  freeze() {
    return y(this, null, function* () {
  ...
  setBackgroundColor(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setBackgroundColor", { instanceId: this._id, backgroundColor: i }), yield this._updateDotLottieInstanceState());
    });
  }
  loadAnimation(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("loadAnimation", { animationId: i, instanceId: this._id }), yield this._updateDotLottieInstanceState());
    });
  }
  setLayout(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setLayout", { instanceId: this._id, layout: i }), yield this._updateDotLottieInstanceState());
    });
  }
  _updateDotLottieInstanceState() {
    return y(this, null, function* () {
      if (!this._created) return;
      let i = yield this._sendMessage("getDotLottieInstanceState", { instanceId: this._id });
      this._dotLottieInstanceState = i.state;
    });
  }
  markers() {
  ...
  setMarker(i) {
    return y(this, null, function* () {
      this._created && (yield this._sendMessage("setMarker", { instanceId: this._id, marker: i }), yield this._updateDotLottieInstanceState());
    });
  }
  setThemeData(i) {
    return y(this, null, function* () {
      if (!this._created) return false;
      let n = yield this._sendMessage("setThemeData", { instanceId: this._id, themeData: i });
      return yield this._updateDotLottieInstanceState(), n;
    });
  }
  setViewport(i, n, h, s) {
    return y(this, null, function* () {
      return this._created ? this._sendMessage("setViewport", { x: i, y: n, width: h, height: s, instanceId: this._id }) : false;
    });
  }
  _sendMessage(i, n, h) {
    return y(this, null, function* () {
      let s = { id: `dotlottie-request-${t3()}`, method: i, params: n };
      return this._worker.postMessage(s, h || []), new Promise((m, M) => {
        let C = (I) => {
          let P = I.data;
          P.id === s.id && (this._worker.removeEventListener("message", C), P.error ? M(new Error(`Failed to execute method ${i}: ${P.error}`)) : m(P.result));
        };
  ...
  loadStateMachine(i) {
    return y(this, null, function* () {
      if (!this._created) return false;
      let n = yield this._sendMessage("loadStateMachine", { instanceId: this._id, stateMachineId: i });
      return yield this._updateDotLottieInstanceState(), n;
    });
  }
  loadStateMachineData(i) {
    return y(this, null, function* () {
      if (!this._created) return false;
      let n = yield this._sendMessage("loadStateMachineData", { instanceId: this._id, stateMachineData: i });
      return yield this._updateDotLottieInstanceState(), n;
    });
  }
  startStateMachine() {
    return y(this, null, function* () {
      ...
      let i = yield this._sendMessage("startStateMachine", { instanceId: this._id });
  ...
  _getPointerPosition(i) {
    let n = this._canvas.getBoundingClientRect(), h = this._canvas.width / n.width, s = this._canvas.height / n.height, m = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, M = (i.clientX - n.left) * h / m, C = (i.clientY - n.top) * s / m;
    return { x: M, y: C };
  }
  _onPointerUp(i) {
    let { x: n, y: h } = this._getPointerPosition(i);
    this._sendMessage("postPointerUpEvent", { instanceId: this._id, x: n, y: h });
  }
  _onPointerDown(i) {
    let { x: n, y: h } = this._getPointerPosition(i);
    this._sendMessage("postPointerDownEvent", { instanceId: this._id, x: n, y: h });
  }
  _onPointerMove(i) {
    let { x: n, y: h } = this._getPointerPosition(i);
    this._sendMessage("postPointerMoveEvent", { instanceId: this._id, x: n, y: h });
  }
  _onPointerEnter(i) {
    let { x: n, y: h } = this._getPointerPosition(i);
    this._sendMessage("postPointerEnterEvent", { instanceId: this._id, x: n, y: h });
  }
  _onPointerLeave(i) {
    let { x: n, y: h } = this._getPointerPosition(i);
    this._sendMessage("postPointerExitEvent", { instanceId: this._id, x: n, y: h });
  }
  _setupStateMachineListeners() {
    return y(this, null, function* () {
      if (W && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
        let i = yield this._sendMessage("getStateMachineListeners", { instanceId: this._id });
        i.includes("PointerUp") && this._canvas.addEventListener("pointerup", this._pointerUpMethod), i.includes("PointerDown") && this._canvas.addEventListener("pointerdown", this._pointerDownMethod), i.includes("PointerMove") && this._canvas.addEventListener("pointermove", this._pointerMoveMethod), i.includes("PointerEnter") && this._canvas.addEventListener("pointerenter", this._pointerEnterMethod), i.includes("PointerExit") && this._canvas.addEventListener("pointerleave", this._pointerExitMethod);
      }
    });
  }
...
p(w2, "_workerManager", new m0()), p(w2, "_wasmUrl", "");
var G1 = w2;
var K1 = ({ animationId: d, autoplay: i, backgroundColor: n, className: h, createDotLottie: s, data: m, dotLottieRefCallback: M, layout: C, loop: I, mode: P, playOnHover: A, renderConfig: n1, segment: q, speed: J, src: r1, style: _1, themeData: l1, themeId: s1, useFrameInterpolation: Z, workerId: S, ...t1 }) => {
  let [z, K] = (0, import_react.useState)(null), w = (0, import_react.useRef)(null), k = (0, import_react.useRef)(null), m1 = (0, import_react.useRef)(M), L1 = { speed: J, mode: P, loop: I, useFrameInterpolation: Z, segment: q, backgroundColor: n, autoplay: i, themeId: s1, workerId: S, src: r1, data: m, layout: C, renderConfig: n1 }, d1 = (0, import_react.useRef)(L1);
  m1.current = M, k.current = z, d1.current = L1, (0, import_react.useEffect)(() => {
    typeof m1.current == "function" && z && m1.current(z);
  }, [z]);
  let A1 = (0, import_react.useCallback)((X) => {
    if (w.current = X, X) {
      let p1 = s({ ...d1.current, canvas: X });
      K(p1);
    } else z == null ? void 0 : z.destroy(), K(null);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let X = (p1) => {
      var _a2, _b2;
      A && (p1.type === "mouseenter" && ((_a2 = k.current) == null ? void 0 : _a2.play()), p1.type === "mouseleave" && ((_b2 = k.current) == null ? void 0 : _b2.pause()));
    };
    return (_a = w.current) == null ? void 0 : _a.addEventListener("mouseenter", X), (_b = w.current) == null ? void 0 : _b.addEventListener("mouseleave", X), () => {
      var _a2, _b2;
      (_a2 = w.current) == null ? void 0 : _a2.removeEventListener("mouseenter", X), (_b2 = w.current) == null ? void 0 : _b2.removeEventListener("mouseleave", X);
    };
  }, [A]), (0, import_react.useEffect)(() => () => {
    z && (z.destroy(), K(null));
  }, [z]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setSpeed(J ?? 1);
  }, [J]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setMode(P ?? "forward");
  }, [P]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setLoop(I ?? false);
  }, [I]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setUseFrameInterpolation(Z ?? true);
  }, [Z]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (q == null ? void 0 : q[0]) == "number" && typeof q[1] == "number" && ((_a = k.current) == null ? void 0 : _a.setSegment(q[0], q[1]));
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setRenderConfig(n1 ?? {});
  }, [JSON.stringify(n1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof m != "string" && typeof m != "object" || ((_a = k.current) == null ? void 0 : _a.load({ data: m, ...d1.current }));
  }, [m]), (0, import_react.useEffect)(() => {
    var _a;
    typeof r1 == "string" && ((_a = k.current) == null ? void 0 : _a.load({ src: r1, ...d1.current }));
  }, [r1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setMarker(t1.marker ?? "");
  }, [t1.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.loadAnimation(d ?? "");
  }, [d]), (0, import_react.useEffect)(() => {
    var _a;
    typeof s1 == "string" && ((_a = k.current) == null ? void 0 : _a.setTheme(s1));
  }, [s1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setThemeData(l1 ?? "");
  }, [l1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = k.current) == null ? void 0 : _a.setLayout(C ?? {});
  }, [C == null ? void 0 : C.fit, (C == null ? void 0 : C.align) && C.align[0], (C == null ? void 0 : C.align) && C.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: h, ...!h && { style: { width: "100%", height: "100%", lineHeight: 0, ..._1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: A1, style: { width: "100%", height: "100%" }, ...t1 }) });
};
var y0 = (d) => new V1(d);
var z0 = (d) => (0, import_jsx_runtime.jsx)(K1, { ...d, createDotLottie: y0 });
var w0 = (d) => new G1(d);
var J0 = (d) => (0, import_jsx_runtime.jsx)(K1, { ...d, createDotLottie: w0 });
var K0 = (d) => {
  G1.setWasmUrl(d), V1.setWasmUrl(d);
};
export {
  z0 as DotLottieReact,
  J0 as DotLottieWorkerReact,
  K0 as setWasmUrl
};
